...
export default function Home() {
  ...
  return (
    <main style={{ backgroundColor: "#abcdef", color: "#000500" }}> {/* Modify background color and text color here */}
      <Toaster />
      <div className="relative flex flex-col items-center justify-center h-screen w-screen">
        <h1 className="text-4xl mb-8 p-2">LiveSpace: 3D Audio Integration with WebRTC</h1>
        <form
          onSubmit={(e) => {
            e.preventDefault();
            joinRoom();
